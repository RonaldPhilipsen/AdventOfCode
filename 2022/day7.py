...
class Directory:
    ...
    def get_size(self):
        ...
        dict_size = sum([directory.get_size()
        ...
        if line.startswith('$ cd'):
            ...
            if selected_dir == '/':
                ...
                if selected_dir not in current_dir.directories:
                    raise Exception(
                        'Tried to cd to directory that doesn´t exist')
...
if __name__ == "__main__":
    ...
    part1 = sum([directory.get_size()
                for directory in directories if directory.get_size() < 100000])
    print(part1)
    ...
    part2 = min([directory.get_size()
                for directory in directories if directory.get_size() > need_to_remove])
    print(part2)
