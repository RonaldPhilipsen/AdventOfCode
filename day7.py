...
class Directory:
    ...
    def get_size(self):
        ...
        dict_size = sum([directory.get_size() for directory in self.directories.values()])
...
part1 = sum([directory.get_size() for directory in directories if directory.get_size() < 100000])
print(part1)
...
part2 = min([directory.get_size() for directory in directories if directory.get_size() > need_to_remove])
